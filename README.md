...
Backend API built with **FastAPI**, following clean architecture principles, JWT authentication, automated testing, and a fully containerized environment using Docker.

---

## About the project

This project is a backend API for user authentication and order management, designed with a focus on:
